...
number_of_internal_multipler_registers = 1
valid_in_to_out_delay = 3 + number_of_internal_multipler_registers
...
# Registers from [1] to [n-3] being the internal multiplier registers
...
if testing_overflow_underflow:
    input_file = open("tb_input_pt4_2_flow.txt", "w")
    output_file = open("tb_output_pt4_2_flow.txt", "w")
    io_test_file = open("tb_io_pt4_2_flow.txt", "w")
else:
    input_file = open("tb_input_pt4_2.txt", "w")
    output_file = open("tb_output_pt4_2.txt", "w")
    io_test_file = open("tb_io_pt4_2.txt", "w")

# Generates a new random input or use an already defined input text file
if random_generate == True:
    if testing_overflow_underflow:
        txt_input = open("input_pt4_2_flow.txt", "w")
    else:
        txt_input = open("input_pt4_2.txt", "w")
else:
    txt_input = open("input_pt4_2.txt", "r")
